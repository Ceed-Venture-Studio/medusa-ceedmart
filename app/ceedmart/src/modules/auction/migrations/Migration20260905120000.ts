  ...
  async up(): Promise<void> {
    this.addSql(`
      create table if not exists "auction" (
        ...
        "starting_price_raw" jsonb null,
        "min_increment" numeric not null,
        "min_increment_raw" jsonb null,
        "reserve_price" numeric null,
        "reserve_price_raw" jsonb null,
        "buy_now_price" numeric null,
        "buy_now_price_raw" jsonb null,
        "deposit_amount" numeric null,
        "deposit_amount_raw" jsonb null,
        "currency_code" text not null default 'ngn',
        "current_price" numeric null,
        "current_price_raw" jsonb null,
