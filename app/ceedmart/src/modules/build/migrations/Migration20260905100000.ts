  ...
  async up(): Promise<void> {
    this.addSql(`
      create table if not exists "build_request" (
        ...
        "raw_budget_min" jsonb null,
        "budget_max" numeric null,
        "raw_budget_max" jsonb null,
    ...
    this.addSql(`
      create table if not exists "build_quote_version" (
        ...
        "raw_subtotal" jsonb null,
        "discount_total" numeric not null default 0,
        "raw_discount_total" jsonb null,
        "tax_total" numeric not null default 0,
        "raw_tax_total" jsonb null,
        "delivery_total" numeric not null default 0,
        "raw_delivery_total" jsonb null,
